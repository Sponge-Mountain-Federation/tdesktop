...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SMFgram.SMFgramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SMFgram.SMFgramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"SMFgram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"SMFgram Desktop/SMFgram.lnk"_q;
	const auto old = u"SMFgram Win (SMF official)/SMFgram.lnk"_q;
